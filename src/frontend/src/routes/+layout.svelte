...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
	<div class="mx-auto max-w-screen-xl text-center">
		<a href="/" class="flex dark:hidden justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
            <img src={LogoImg} class="mr-3 h-8" alt="Logo" />
		</a>
		<a href="/" class="dark:flex hidden justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
            <img src={LogoDarkImg} class="mr-3 h-8" alt="Logo" />
		</a>
		<p class="my-6 text-gray-500 dark:text-gray-400">Brezplačna aplikacija za obveščanje o prostih terminih za opravljanje vozniškega izpita.</p>
		...
		<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">Termini™</a></span>
	</div>
</footer>